...
// NOTE: this project already ships framer-motion (the same library now published
// as "motion"). We import from framer-motion to avoid bundling a duplicate engine.
        ...
        <div className="container mx-auto mt-12 px-4 text-center">
          ...
          <div className="relative mx-auto my-20 w-full max-w-6xl">
            ...
            <img
              ...
              className="relative w-full h-auto shadow-md grayscale rounded"
            />
          </div>
        </div>
      </div>
